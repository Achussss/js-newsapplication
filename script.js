function getNewsByCategory(){
  ...
  console.log(category);
   ...
   fetch(`https://newsapi.org/v2/top-headlines?country=in&category=${category}&apiKey=d8f76e99cdaa4a9e9616f0dbe4d4b1f9`).
...
function getNews(){
  ...
  fetch(`https://newsapi.org/v2/top-headlines?country=in&apiKey=b0a666511539405e88a216e939cba720
  `).
  then(res=>res.json()).then(data=>headlines(data))
...
function headlines(data){
  ...
  <div class="card mb-3 ms-5 mt-3 bg-secondary --bs-bg-opacity:80%;" style="margin-left: 700px; width: 600px;">
